...
export const ProductForm = ({ title, subTitle, product, onSubmit, isPending }: Props) => {
  ...
  // Para detonar un Re-Render cuando las tallas cambien
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    // setFiles(prev => [...prev, ...Array.from(files)]); // Deprecado porque "files ya es parte del form"
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // // setFiles(Array.from(files)); // Para sustituir los archivos previamente cargados
    // setFiles(prev => [...prev, ...Array.from(files)]); // Para mantener los archivos previamente cargados
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {
                      errors.stock && (
                        <p className="text-red-500 text-sm">El inventario debe ser mayor a cero</p>
                      )
                    }
                  </div>
                </div>
